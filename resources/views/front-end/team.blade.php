        ...
        <div class="container-fluid py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    ...
                    <p>Meet our passionate and experienced teachers who make learning fun, engaging, and meaningful for every child.
They inspire students with care, creativity, and personalized attention in a supportive environment.</p>
                </div>
                <div class="row g-4">
                ...
                @foreach($teachers as $teacher)
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item position-relative">
                            <img class="img-fluid rounded w-100" src="{{ asset('uploads/teachers/' . $teacher->teacher_logo) }}" alt="">
                            <div class="team-text">
                                <h3>{{$teacher->name}}</h3>
                                <p>Teacher</p>
