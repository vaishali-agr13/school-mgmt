        ...
        <div class="container-fluid py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    ...
                    <p>We’d love to hear from you! Contact us for admissions, inquiries, or to learn more about our programs and activities.
Our team is always ready to assist you and guide your child toward a brighter future..</p>
                </div>
                <div class="row g-4 mb-5">
                    <div class="col-md-6 col-lg-4 text-center wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <h6>B-46, Tirupati Abhinav Homes, Ayodhya By Pass Road,Bhopal</h6>
                    </div>
