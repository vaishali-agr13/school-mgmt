        ...
        <div class="container-fluid py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    ...
                    <p>Our well-designed classes combine learning with fun to help children develop creativity, confidence, and essential skills.
We provide a nurturing environment where every child can learn, explore, and grow happily..</p>
                </div>
                <div class="row g-4">
